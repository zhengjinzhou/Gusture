package com.zhou.readbook.view.recyclerview;
...
import com.zhou.readbook.utils.NetworkUtils;
import com.zhou.readbook.utils.ToastUtils;
import com.zhou.readbook.view.adapter.RecyclerArrayAdapter;
import com.zhou.readbook.view.decoration.DividerDecoration;
import com.zhou.readbook.view.recyclerview.swipe.OnRefreshListener;
import com.zhou.readbook.view.recyclerview.swipe.SwipeRefreshLayout;
...
public class EasyRecyclerView extends FrameLayout{
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.superrecyclerview);
        try {
            mClipToPadding = typedArray.getBoolean(R.styleable.superrecyclerview_recyclerClipToPadding, false);
            mPadding = (int) typedArray.getDimension(R.styleable.superrecyclerview_recyclerPadding, -1.0f);
            mPaddingTop = (int) typedArray.getDimension(R.styleable.superrecyclerview_recyclerPaddingTop, 0.0f);
            mPaddingBottom = (int) typedArray.getDimension(R.styleable.superrecyclerview_recyclerPaddingBottom, 0.0f);
            mPaddingLeft = (int) typedArray.getDimension(R.styleable.superrecyclerview_recyclerPaddingLeft, 0.0f);
            mPaddingRight = (int) typedArray.getDimension(R.styleable.superrecyclerview_recyclerPaddingRight, 0.0f);
            mScrollbarStyle = typedArray.getInteger(R.styleable.superrecyclerview_scrollbarStyle, -1);
            mScrollbar = typedArray.getInteger(R.styleable.superrecyclerview_scrollbars, -1);

            mEmptyId = typedArray.getResourceId(R.styleable.superrecyclerview_layout_empty, 0);
            mProgressId = typedArray.getResourceId(R.styleable.superrecyclerview_layout_progress, 0);
            mErrorId = typedArray.getResourceId(R.styleable.superrecyclerview_layout_error, R.layout.common_net_error_view);
        }finally {
            typedArray.recycle();
        }
    }
    ...
    private void initView() {
        ...
        mPtrLayout = v.findViewById(R.id.fresh);
